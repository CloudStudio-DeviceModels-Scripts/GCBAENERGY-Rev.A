...
# Configuration Script – GCBAENERGY - Rev. A

This **Configuration** script is designed for the **GCBAENERGY** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – GCBAENERGY Rev. A

Este script de **Configuration** está diseñado para el modelo **GCBAENERGY** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
